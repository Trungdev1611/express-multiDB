...
userRouter.post(`/send-node-mailer`, validateBody(emailSchema), EmailNodeMailer)

userRouter.post(`/send-list-node-mailer`, validateBody(sendEmailSchemaList), EmailNodeMailerListUser)
